...
* @return 插入是否成功
*/
_Bool insertAList(struct ArrayList* alist,void * element, int index);
/**
...
* @return 是否删除成功
*/
_Bool removeAList(struct ArrayList* alist, int index);
/**
...
*/
_Bool removeAListByPtr(struct ArrayList* alist, void * element);
/**
* 替换指定下标处的指针
* @param alist 指定的ArrayList结构体
...
* @return 替换是否成功
*/
_Bool replaceAListRls(struct ArrayList* alist, int index, void * newElement);
/**
* 查找指定的指针
* @param alist 指定的ArrayList结构体
